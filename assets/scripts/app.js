...
document
    ...
    .addEventListener("click", drawing.bind(null, "ArrowUp"));
document
    .querySelector(".btn-down")
    .addEventListener("click", drawing.bind(null, "ArrowDown"));
document
    .querySelector(".btn-left")
    .addEventListener("click", drawing.bind(null, "ArrowLeft"));
document
    .querySelector(".btn-right")
    .addEventListener("click", drawing.bind(null, "ArrowRight"));
